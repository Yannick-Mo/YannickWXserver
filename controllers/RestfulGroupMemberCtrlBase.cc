...
void RestfulGroupMemberCtrlBase::getOne(const HttpRequestPtr &req,
                                        ...
                                        GroupMember::PrimaryKeyType &&id)
{
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    drogon::orm::Mapper<GroupMember> mapper(dbClientPtr);
    mapper.findByPrimaryKey(
        id,
        [req, callbackPtr, this](GroupMember r) {
...
void RestfulGroupMemberCtrlBase::updateOne(const HttpRequestPtr &req,
                                           std::function<void(const HttpResponsePtr &)> &&callback,
                                           GroupMember::PrimaryKeyType &&id)
{
    ...
    try
    {
        if(isMasquerading())
        {
            if(!GroupMember::validateMasqueradedJsonForUpdate(*jsonPtr, masqueradingVector(), err))
            {
                Json::Value ret;
                ret["error"] = err;
                auto resp= HttpResponse::newHttpJsonResponse(ret);
        ...
        {
            if(!GroupMember::validateJsonForUpdate(*jsonPtr, err))
            {
                Json::Value ret;
                ret["error"] = err;
                auto resp= HttpResponse::newHttpJsonResponse(ret);
...
void RestfulGroupMemberCtrlBase::deleteOne(const HttpRequestPtr &req,
                                           std::function<void(const HttpResponsePtr &)> &&callback,
                                           GroupMember::PrimaryKeyType &&id)
{
...
void RestfulGroupMemberCtrlBase::get(const HttpRequestPtr &req,
                                     std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto dbClientPtr = getDbClient();
    drogon::orm::Mapper<GroupMember> mapper(dbClientPtr);
    ...
    if(jsonPtr && jsonPtr->isMember("filter"))
    {
        try{
            ...
            mapper.findBy(criteria,
                [req, callbackPtr, this](const std::vector<GroupMember> &v) {
                    Json::Value ret;
                    ret.resize(0);
                    for (auto &obj : v)
                    {
    ...
    {
        mapper.findAll([req, callbackPtr, this](const std::vector<GroupMember> &v) {
                Json::Value ret;
                ret.resize(0);
                for (auto &obj : v)
                {
...
void RestfulGroupMemberCtrlBase::create(const HttpRequestPtr &req,
                                        std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto jsonPtr=req->jsonObject();
    if(!jsonPtr)
    ...
    if(isMasquerading())
    {
        if(!GroupMember::validateMasqueradedJsonForCreation(*jsonPtr, masqueradingVector(), err))
        {
            Json::Value ret;
            ret["error"] = err;
            auto resp= HttpResponse::newHttpJsonResponse(ret);
    ...
    {
        if(!GroupMember::validateJsonForCreation(*jsonPtr, err))
        {
            Json::Value ret;
            ret["error"] = err;
            auto resp= HttpResponse::newHttpJsonResponse(ret);
    ...
    try 
    {
        GroupMember object = 
            (isMasquerading()? 
             GroupMember(*jsonPtr, masqueradingVector()) : 
             GroupMember(*jsonPtr));
        auto dbClientPtr = getDbClient();
        auto callbackPtr =
            std::make_shared<std::function<void(const HttpResponsePtr &)>>(
        ...
        mapper.insert(
            object,
            [req, callbackPtr, this](GroupMember newObject){
...
/*
void RestfulGroupMemberCtrlBase::update(const HttpRequestPtr &req,
                                        std::function<void(const HttpResponsePtr &)> &&callback)
{

}*/

RestfulGroupMemberCtrlBase::RestfulGroupMemberCtrlBase()
    : RestfulController({
          "id",
          "group_id",
          "user_id",
      ...
      })
{
    ...
    */
    enableMasquerading({
        ...
        "join_time", // the alias for the join_time column.
