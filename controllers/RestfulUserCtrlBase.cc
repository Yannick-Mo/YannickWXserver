      ...
      })
{
    ...
    */
    enableMasquerading({
        ...
        "birth_date", // the alias for the birth_date column.
        "region", // the alias for the region column.
        "signature", // the alias for the signature column.
        "status", // the alias for the status column.
        "last_login_time", // the alias for the last_login_time column.
        "last_login_ip", // the alias for the last_login_ip column.
