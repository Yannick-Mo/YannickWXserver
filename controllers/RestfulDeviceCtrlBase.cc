...
void RestfulDeviceCtrlBase::getOne(const HttpRequestPtr &req,
                                   ...
                                   Device::PrimaryKeyType &&id)
{
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    drogon::orm::Mapper<Device> mapper(dbClientPtr);
    mapper.findByPrimaryKey(
        id,
        [req, callbackPtr, this](Device r) {
...
void RestfulDeviceCtrlBase::updateOne(const HttpRequestPtr &req,
                                      std::function<void(const HttpResponsePtr &)> &&callback,
                                      Device::PrimaryKeyType &&id)
{
    ...
    try
    {
        if(isMasquerading())
        {
            if(!Device::validateMasqueradedJsonForUpdate(*jsonPtr, masqueradingVector(), err))
            {
                Json::Value ret;
                ret["error"] = err;
                auto resp= HttpResponse::newHttpJsonResponse(ret);
        ...
        {
            if(!Device::validateJsonForUpdate(*jsonPtr, err))
            {
                Json::Value ret;
                ret["error"] = err;
                auto resp= HttpResponse::newHttpJsonResponse(ret);
...
void RestfulDeviceCtrlBase::deleteOne(const HttpRequestPtr &req,
                                      std::function<void(const HttpResponsePtr &)> &&callback,
                                      Device::PrimaryKeyType &&id)
{
...
void RestfulDeviceCtrlBase::get(const HttpRequestPtr &req,
                                std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto dbClientPtr = getDbClient();
    drogon::orm::Mapper<Device> mapper(dbClientPtr);
    ...
    if(jsonPtr && jsonPtr->isMember("filter"))
    {
        try{
            ...
            mapper.findBy(criteria,
                [req, callbackPtr, this](const std::vector<Device> &v) {
                    Json::Value ret;
                    ret.resize(0);
                    for (auto &obj : v)
                    {
    ...
    {
        mapper.findAll([req, callbackPtr, this](const std::vector<Device> &v) {
                Json::Value ret;
                ret.resize(0);
                for (auto &obj : v)
                {
...
void RestfulDeviceCtrlBase::create(const HttpRequestPtr &req,
                                   std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto jsonPtr=req->jsonObject();
    if(!jsonPtr)
    ...
    if(isMasquerading())
    {
        if(!Device::validateMasqueradedJsonForCreation(*jsonPtr, masqueradingVector(), err))
        {
            Json::Value ret;
            ret["error"] = err;
            auto resp= HttpResponse::newHttpJsonResponse(ret);
    ...
    {
        if(!Device::validateJsonForCreation(*jsonPtr, err))
        {
            Json::Value ret;
            ret["error"] = err;
            auto resp= HttpResponse::newHttpJsonResponse(ret);
    ...
    try 
    {
        Device object = 
            (isMasquerading()? 
             Device(*jsonPtr, masqueradingVector()) : 
             Device(*jsonPtr));
        auto dbClientPtr = getDbClient();
        auto callbackPtr =
            std::make_shared<std::function<void(const HttpResponsePtr &)>>(
        ...
        mapper.insert(
            object,
            [req, callbackPtr, this](Device newObject){
...
/*
void RestfulDeviceCtrlBase::update(const HttpRequestPtr &req,
                                   std::function<void(const HttpResponsePtr &)> &&callback)
{

}*/

RestfulDeviceCtrlBase::RestfulDeviceCtrlBase()
    : RestfulController({
          "id",
          "user_id",
          "device_id",
      ...
      })
{
    ...
    */
    enableMasquerading({
        ...
        "device_id", // the alias for the device_id column.
        "device_type", // the alias for the device_type column.
        "push_token", // the alias for the push_token column.
        "last_active_time", // the alias for the last_active_time column.
